...
<div class="signUpContainer">
    ...
    <spring:message code="label.result"/>${result.correctAnswers}<spring:message code="label.resultOutOf"/>${result.quiz.questions.size}
    <form action="/quizApp/student" method="get">
        <input type="submit" value="Go to my link location"
               name="Submit" id="frm1_submit" />
    </form>
    <button class="greenButton" type="submit" onclick="welcome()">OK</button>
</div>
</body>
</html>
