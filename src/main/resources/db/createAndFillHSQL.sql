...
DROP SEQUENCE answer_sequence IF EXISTS;
...
CREATE TABLE users
(
  id               INTEGER           GENERATED BY DEFAULT AS SEQUENCE answer_sequence NOT NULL PRIMARY KEY,
...
--16,17,18,19
(FALSE,  'Wrong answer for Question ONE for quiz about POWER',     12),
(TRUE,   'Correct answer for Question ONE for quiz about POWER',   12),
(FALSE,  'Wrong answer for Question ONE for quiz about POWER',     12),
(FALSE,  'Wrong answer for Question ONE for quiz about POWER',     12),
